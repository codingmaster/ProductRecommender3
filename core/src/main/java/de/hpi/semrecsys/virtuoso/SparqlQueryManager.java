...
public class SparqlQueryManager {
	...
	public enum QueryType {
		ATTRIBUTE_ENTITY_LIST, GET_ALL_ENTITIES, GET_ALL_DBPEDIA_ENTITIES, PRODUCTS_WITH_SIMILAR_ENTITIES, SIMILAR_ENTITIES_BETWEEN_PRODUCTS, IS_PRODUCT_EXISTS, GRAPH_SIZES, GRAPH_NAMES, ENTITY_SIMILARITY;
	}
