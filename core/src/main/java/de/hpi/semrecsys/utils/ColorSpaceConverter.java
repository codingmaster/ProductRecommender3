...
public class ColorSpaceConverter {
	 ...
	 */
	static float Px[] = { 0.00327f, 0.03505f, 0.06577f, 0.05182f, 0.01380f, 0.00065f, 0.02017f, 0.06458f, 0.12087f,
			0.17384f, 0.19266f, 0.14677f, 0.07398f, 0.02616f, 0.00701f, 0.00165f };

	/**
	 * y color matching function tabulated at 20-nm intervals. (10-degree 1964
	 * CIE suppl. std. observer)
	 */
	static float Py[] = { 0.00034f, 0.00367f, 0.01064f, 0.02197f, 0.04347f, 0.07898f, 0.13058f, 0.16489f, 0.17094f,
			0.14893f, 0.11284f, 0.06824f, 0.03082f, 0.01034f, 0.00273f, 0.00062f
	 ...
	 * CIE suppl. std. observer)
	 */
	static float Pz[] = { 0.01474f, 0.16669f, 0.33720f, 0.29917f, 0.13234f, 0.03745f, 0.01040f, 0.00235f, 0f, 0f, 0f,
			0f, 0f, 0f, 0f, 0f };
	 ...
	 * 
	 * @param rgb
	 *            RGB components that are used to compute initial XYZ and LAB
	 *            values.
	 * @see RGBCoord
	 */
	public ColorSpaceConverter(RGBCoord rgb) {
		convertFromRGB(rgb);
	}
	 ...
	 * 
	 * @param rgb
	 *            RGB components to convert from.
	 * @see RGBCoord
	 */
	 ...
	 * 
	 * @param data
	 *            [] an array of 16 spectrum data points.
	 */
	 ...
	 * 
	 * @param rgb
	 *            RGBCoord object to set with converted values.
	 */
	...
	public void XYZtoLAB() {
		...
		aa = 500f * (float) (Math.pow(X, 0.3333333) - Math.pow(Y, 0.3333333));

		bb = 200f * (float) (Math.pow(Y, 0.3333333) - Math.pow(Z, 0.3333333));
