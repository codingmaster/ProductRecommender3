...
/*************************************************
 * File:	RGBCoord
 * Description: This class encapsulates shared RGB coordinates.
 *
...
public class RGBCoord implements Cloneable {
	 ...
	 * 
	 * @param rgb
	 *            [] array to place red, green and blue components,
	 *            respectively.
	 ...
	 * 
	 * @param rgb
	 *            set of components to compare with.
	...
	public synchronized boolean differentFrom(RGBCoord rgb) {
		...
		if (rgb.getRed() != this.getRed() || rgb.getGreen() != this.getGreen() || rgb.getBlue() != this.getBlue())
